...
| Platform | CPU | Time |
|----------|-----|------|
| Linux x86_64 | AMD Ryzen 9 7900X | 44ms |
| Windows 11 x86_64 | Intel Core Ultra 9 275HX | 63ms |
| Linux ARM64 | ARM Cortex-A72 (Pi 400) | 509ms |
...
13,000+ lines of KernRift across 14 source files + 7 stdlib modules (828 lines). Self-compiles to a 350 KB native binary in 44ms, or a 1.96 MB universal fat binary (6 slices) in 229ms (AMD Ryzen 9 7900X). 102 tests, bootstrap fixed point verified on 3 platforms.
